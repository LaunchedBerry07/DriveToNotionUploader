...
var CONFIG = {
 ...
 NOTION: {
   ...
   // The Old Parent Page (Used only for the Migration Script to find pages to move)
   OLD_PARENT_PAGE_ID: '2eac88644424805b9dcdcd07bc9a8df0',
   
   // Database Column Names (Must match Notion exactly)
   PROPS: {
     TITLE_COLUMN: 'ID', // Usually 'Name' or 'Title'
     FILE_COLUMN:'Fichiers'  // Usually 'Files' or 'Files & media'
   }
 },
